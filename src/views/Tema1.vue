  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .py-3.py-md-4(titulo="Planes de Saneamiento")
          .row  
            .col-md-12
              ...
              p Este aspecto reúne el conjunto de actividades clasificadas por programas, que permiten mantener limpio y saneado el ambiente de la fábrica, bodega, almacén y flota de transportes de alimentos y demás recursos físicos de operación, el cual contempla:
    ...
    .row.mt-5
      ...
      .row.img1_t1
        .col-lg-10
          .titulo-sexto.color-acento-contenido.mb-3.mt-5
            p.mb-0 <b>Tabla 1.</b> Normas que parametrizan y rigen las buenas prácticas de manufactura de alimentos en Colombia.
        .col-lg-10
