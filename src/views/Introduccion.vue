...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      figure
        .video
          iframe(width="560" height="315" src="https://www.youtube.com/embed/h4Oi6DbVba8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        figcaption Video: Gestión de portafolio de productos alimenticios
